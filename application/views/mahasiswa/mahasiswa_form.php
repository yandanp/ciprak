...
<body>
	<div class="container">
		...
		<div class="text-center mt-3 mb-5">
			<h3>Formulir Pendaftaran<br>Mahasiswa Baru</h3>
		</div>
		<div class="card">
			<div class="card-body bg-light">
				...
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('nama_lengkap'); ?></span>
				</div>
				<div class="form-group">
					...
					<div class="row">
						...
						<?php echo form_input(array('name'=>'tempat_lahir','maxlength'=>30,'placeholder'=>'Tempat', 'value'=>$tempat_lahir, 'class'=>'form-control'));?>
						<span class="label label-important small alert-danger"><?php echo form_error('tempat_lahir'); ?></span>
						</div>
						<div class="col-md-4">
						<?php echo form_input(array('name'=>'tgl_lahir','placeholder'=>'Tanggal', 'value'=>$tgl_lahir,'class'=>'form-control datepicker '));?>
						<span class="label label-important small alert-danger"><?php echo form_error('tgl_lahir'); ?></span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('agama'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('jkel'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('status'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('alamat'); ?></span>
				</div>	
		</div> <!-- col -->
		...
		<div class="col-md-6">
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('telp'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('asal_sklh'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('thn_lulus'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('n_ijazah'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('n_un'); ?></span>
				</div>
		...
		<div class="card mt-4">
			<div class="card-body bg-light">
				...
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('nama_ayah'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('nama_ibu'); ?></span>
				</div>
				</div>
				<div class="col-md-6">
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('krj_ayah'); ?></span>
				</div>
				<div class="form-group">
					...
					<span class="label label-important small alert-danger"><?php echo form_error('krj_ibu'); ?></span>
				</div>	
		</div> <!-- col -->
		...
		<div class="card mt-4">
			<div class="card-body bg-light">
				<h5 class="card-title">Jurusan/Program Studi yang Dipilih</h5>
				<div class="form-group">
				<span class="span2">Pilih Jurusan</span>
				<?php 
						echo combobox('id_prodi','prodi','nama_prodi','id', $id_prodi);
					?>   
				<span class="label label-important small alert-danger"><?php echo form_error('id_prodi'); ?></span>
			</div>
			</div>
		</div>
